...
def test_draw_circles1():
    ...
    #Test 1
    print('------------------')
    print('Test 1 Draw Circles: See window')
    print('------------------')
    draw_circles1(21)
...
def draw_circles2(n):
    ...
    for k in range(n):
        new_point_x = point_x + (k * 20)
        circle = rg.Circle(rg.Point(new_point_x, 100), 10)
...
def test_draw_circles3():
    ...
    print('------------------')
    print('Test Draw Circles 3: See window')
    print('------------------')
    draw_circles3(100)
